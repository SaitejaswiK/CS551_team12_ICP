...
public class TranslateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner s1 = (Spinner) findViewById(R.id.spinner_2);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
                android.R.layout.simple_spinner_item, arraySpinner);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        s1.setAdapter(adapter);

        Spinner s2 = (Spinner) findViewById(R.id.spinner_3);
    ...
    public void translateText(View v) {
        ...
        m1.put("English","en");m1.put("Spanish","es");
        m1.put("Italian","it");m1.put("Chinese","zh");
        m1.put("Telugu","te");m1.put("Hindi","hi");
        TextView sourceTextView = (TextView) findViewById(R.id.txt_Email);
        Spinner inputSpinner = (Spinner) findViewById(R.id.spinner_2);
        Spinner outputSpinner = (Spinner) findViewById(R.id.spinner_3);
        String inLang = inputSpinner.getSelectedItem().toString();
        inLang = (String) m1.get(inLang);
        String outLang = outputSpinner.getSelectedItem().toString();
        outLang = (String) m1.get(outLang);
